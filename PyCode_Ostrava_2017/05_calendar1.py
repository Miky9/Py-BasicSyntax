# Cílem této úlohy je vypsat kalendář pro konkrétní měsíc. Vstupem bude jméno měsíce (česky nebo anglicky).
# Přestupné roky neberte v úvahu (tj. únor bude mít vždy 28 dnů). Formát výstupu by měl být následující+
#
# Leden
